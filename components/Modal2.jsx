        ...
        if (this.state.showModal) {
            return (
                <div className={'modal ' + (this.state.closing ? 'closing' : '')} onClick={() => this.hideModal()}>
                    ...
                    <button className="flexcc blur-back" style={{ position: 'absolute', top: 15, right: 15, zIndex: 20, backgroundColor: '#00000010', borderRadius: 30, width: 30, height: 30 }} onClick={() => { this.hideModal() }}>
