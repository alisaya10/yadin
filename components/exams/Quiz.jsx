...
class Quiz extends React.Component {
  ...
  time = () => {
    ...
    let seconds = (this.props.quiz.time * 60) - (diff / 1000)
  ...
  sendAnswerToServer(question, answer) {
    ...
    HttpServices.request('submitAnswer', { quiz: this.props.quiz?._id, question: question._id, answer }, ((fetchResult, fetchError) => {
    ...
    return (
      ...
      <div className="text-color-1">
        ...
        <div className="d-flex box-2 p-4 position-sticky" style={{ top: 60, zIndex: '1', maxWidth: '1100px' }}>
          <div className="w-100">
            <button onClick={() => { this.props.endQuiz() }} className="btn-primary4 text-semibig" style={{ maxWidth: '200px', minWidth: '120px' }}>
              <p>اتمام آزمون</p>
            </button>
          </div>
        ...
        <div className="box px-3 pb-3" style={{ maxWidth: '1100px' }}>
          <div>
            {questions?.map((item, index) => {
              // console.log(item.answers)

              return (
                <div className="border-bottom-gray pb-2 pt-3">
                  <div className="d-flex">
                    <p className="text-color-1 text-semibig">{index + 1}- {item.title}</p>
                  </div>
