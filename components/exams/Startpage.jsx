...
class QuizStartPage extends React.Component {
  ...
  startQuiz = () => {
    ...
    HttpServices.request('startQuiz', { quiz: this.props.quiz?._id }, ((fetchResult, fetchError) => {
      ...
      <div className="text-color-1 ">
        ...
        {(!this.props?.current) && (
          <>
            ...
            <div className="box  flexcc" style={{ maxWidth: '900px' }}>
        ...
        {(this.props?.current && this.props.current.finishTime) && (
          ...
          <>
            <div className="box p-4 " style={{ maxWidth: '900px' }}>
              ...
              <div className="row m-0 pt-4">
                <div className="col-12 col-lg-8 p-0">
                  <p className="text-normal text-color-2">{this.props.quiz?.description}</p>
                </div>
                <div className="col-12 col-lg-4 p-0">
                  <div className="row m-0">
                    <div className="col-12 col-lg-12 col-md-6 flexc justify-content-lg-end pt-4 pt-lg-0">
            ...
            <div className="flexcc">
              <div className="flexcc" style={{ width: '900px' }}>


                <LoaderButton
                  onClick={this.startQuiz}
                  isLoading={this.state.isLoading}
                  text='انجام مجدد آزمون'
                  type={"ThreeDots"}
                  className="mt-4 mb-4 btn1 text-semibig "
                  buttonClassName="green-color"
                  buttonStyle={{ fontSize: 15, fontWeight: 'bold', }}
