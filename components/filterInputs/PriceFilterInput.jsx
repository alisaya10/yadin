...
class PriceFilterInput extends React.Component {
    state = {
        value: '',
        showValue: '',
        operator: 'between'
        ...
        return (
            <div className='mt-0 w-100 flexc text-center' >
                <div className="px-2" style={{ backgroundColor: '#ffffff90', borderRadius: 8, flex: 1 }}>
                    <PriceInput data={this.state.data ? this.state.data[0] : null} header={{ key: 0, information: { placeholder: 'From' } }} changeValue={this.changeValue} />
                </div>
                <p className='mx-1'>-</p>
                <div className="px-2" style={{ backgroundColor: '#ffffff90', borderRadius: 8, flex: 1 }}>
                    <PriceInput data={this.state.data ? this.state.data[1] : null} header={{ key: 1, information: { placeholder: 'To' } }} changeValue={this.changeValue} />
                </div>
