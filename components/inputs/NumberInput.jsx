    ...
    render() {
        return (
            <div className="w-100 h-100">
                <input ref={el => this.input = el} pattern="[0-9]*" autoFocus={this.props.header.information?.autoFocus} value={this.props.data != null ? this.props.data : ''} maxLength={this.props.header.information.maxLength} onChange={(e) => this.changeInputValue(e.target)} placeholder={checkTextTranslation(this.props.header.information.placeholder)} className="transpanet-input" />
            </div>
        )
    }
}
