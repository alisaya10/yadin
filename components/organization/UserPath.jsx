...
class Path extends React.Component {
  ...
  // componentDidUpdate(){
  //   if (!this.state.path || this.state.path == null || this.state.path == undefined){
  //     this.setState({ path: this.props.orgInfo?.learningPath }, () => {
  //       console.log('...................', this.state.path);
  //       this.setUnselectable()
  //     })
  ...
  setUnselectable = () => {
    let NoScore = []
    for (let i = 0; i < this.props.orgInfo?.learningPath?.course?.length; i++) {
      const course = this.props.orgInfo?.learningPath?.course[i];
      if (!course?.finalScore || course?.finalScore == null || course?.finalScore == 0)
        NoScore.push(i)

    }
    this.setState({ firstSelectable: NoScore[0] })
      ...
      <>
        <div className="container">
          <div className="py-2 pb-4">
            ...
            {Array.isArray(this.props.orgInfo?.learningPath.course) && this.props.orgInfo?.learningPath.course.map((item, index) => {

              return (


                <div className="flexcc">
                  {item?.finalScore && item?.finalScore >= 10 && (

                    <div className="flexcc flex-column flex-1" style={{ alignSelf: 'stretch' }}>
                      <div className="ml-2 mb-2 radius-1" style={{ backgroundColor: index == 0 ? "transparent" : "#C97EF5", width: "4px", flex: 1 }}>
                      </div>
                      <div className="p-1 flexcc text-color-2 ml-2" style={{ background: "#C97EF5", borderRadius: "50%", width: 30, height: 30 }}>
                        <p style={{ color: '#fff' }}>{index + 1} </p>
                      </div>
                      <div className="ml-2 mt-2 radius-1" style={{ backgroundColor: index == this.props.orgInfo?.learningPath?.course?.length - 1 ? 'transparent' : "#C97EF5", width: "4px", flex: 1 }}>
                      </div>
                    </div>
                  )}
                  {(!item?.finalScore || item?.finalScore <= 10) && (
                    ...
                    <div className="flexcc flex-column flex-1" style={{ alignSelf: 'stretch' }}>
                      ...
                      <div className="ml-2 mt-2 radius-1" style={{ backgroundColor: index == this.props.orgInfo?.learningPath.course?.length - 1 ? 'transparent' : "#202020", width: "4px", flex: 1 }}>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="pt-3 w-100">
                    <div className="box-1 radius-1">
                      <div className="row m-0 " style={{ display: 'flex', justifyContent: 'space-between' }}>
                        {(item.finalScore > 0 || index == this.state.firstSelectable) ? (
                            ...
                            <div className="col-12 col-xl-12">
                              <div className="row m-0 flexc">
                                ...
                                <div className="p-0 col-12 col-md-6 col-lg-3 d-flex flexc justify-content-md-end">
                                  ...
                                  {/* {console.log('tttt',this.state.firstSelectable)} */}
                                  {(item.finalScore > 0 || index == this.state.firstSelectable) && (
                                    <div>
