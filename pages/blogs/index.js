  ...
  render() {
    ...
    return (
      <div className="" >
        ...
        <div className="blog-hero flex-column flexcc pt-3" style={{ background: "#0052cc", backgroundSize: 'cover', backgroundPosition: 'center' }}>
          ...
          <h1 className="mb-1 blog-hero-header">IoTSmile {checkTranslation('{{lang}}Hub')}</h1>
          <p className="mb-3 " style={{ color: '#fff', fontSize: 24 }}>{checkTranslation('{{lang}}blogs-desc-under-title')}</p>

          <div className="blog-inputbox position-relative">
            <input className="blog-input" placeholder={checkTranslation('{{lang}}Search-box-blog')} style={{ fontSize: 16 }} onChange={e => this.doSearch(e.target.value)} />
          ...
          <div className="blog-hero-pbox">
            <p className="blog-hero-p">{checkTranslation('{{lang}}under-search-desc-blogs-page')}</p>
          </div>
        </div>
                            ...
                            <div className="w-100 h-100 d-flex " style={{ padding: '10px 2px 15px 2px', borderRadius: '4px' }} >
                              <div className="px-1 pt-1 d-flex" >
                                ...
                                <div className="px-3   flex-column  ">
                                  <p className="w-100" style={{ fontSize: '16px', fontWeight: '500', maxWidth: '260px', }}>{item.title}</p>
        ...
        <div className="container p-1 pt-4 px-3" style={{ borderTop: '1px solid #ddd' }}>
          <div className="px-2">
            <p className="" style={{ fontSize: '28px', color: '#000', fontWeight: '600' }}>{checkTranslation('{{lang}}Latest-Blogs')}</p>
          </div>
          <div className="d-flex  pb-4 mt-2 no-scrollbar" style={{overflow:'auto'}}>
                  ...
                  <a className="p-1  text-start ">
                    <div className=" d-flex px-2" style={{ background: this.props.category == prop._id ? 'rgb(0, 82, 204)' : '#fff', borderRadius: 2, boxShadow: 'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px', borderRadius: 4 }}>
                      ...
                      <div className="mx-2 mt-2 mb-1 pt-1 text-start">
                        ...
                        <p className="" style={{ color: this.props.category == prop._id ? '#fff' : '#102030', fontSize: 15, fontWeight: '',whiteSpace:'nowrap' }}>{prop?.values.title}</p>
                        {/* <p className="" style={{ color: '#789', fontSize: 13 }}>This is the test test for the description</p> */}
                      </div>
                    </div>
                  </a>
