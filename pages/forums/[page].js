...
export async function getServerSideProps(context) {
    ...
    const docsRes = await (await HttpServices.syncRequest('getUsersQuestions', body)).result
        ...
        return (
            ...
            /> */}
                ...
                <div className="blog-hero flex-column flexcc pt-5" style={{ backgroundImage: "url('/images/svg-8.svg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    ...
                    <h1 className="mb-1 blog-hero-header">IoTSmile {checkTranslation('{{lang}}Forums')}</h1>
                    ...
                    <div className="blog-inputbox position-relative mb-5">
                        <input className="blog-input" placeholder={checkTranslation('{{lang}}Search-box')} style={{ fontSize: 16 }} onChange={e => this.doSearch(e.target.value)} />
