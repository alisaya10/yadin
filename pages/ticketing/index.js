...
//   const dataRes = await (await HttpServices.syncRequest('getTickets', body)).result
...
class Ticketing extends React.Component {
  state = {
    ...
    headers: [
      ...
      { key: 'body', type: 'TextAreaInput', col: '12', information: { label: '{{lang}}متن تیکت', placeholder: '{{lang}}متن تیکت', required: true, inputClass: 'null' }, showMain: false },
  ...
  getStatusInfo(status) {
    switch (status) {
      ...
      case '-1':
        return { label: '{{lang}}Closed', color: '#000', icon: '' }
        break;
      ...
      <div className="p-0 container-fluid"  >
        <div className="row m-0" >
          ...
          {(this.state.stage == 1 || this.state.width > 767) && (
            <div className="col-md-5 col-lg-3 p-0 m-0" style={{ backgroundColor: '#f2f6f8', borderRight: '1px solid #eee', borderLeft: '1px solid #eee' }}>
              ...
              <div className="no-scrollbar w-100" style={{ height: this.state.width > 767 ? 'calc(100vh - 50px)' : '', overflow: this.state.width > 767 ? 'auto' : '' }}>
                ...
                <div className='flexcc'>
                  <div className='px-3 py-1 pb-2 pt-2 w-100' style={{ borderBottom: '1px solid #eee' }}>
          ...
          {(this.state.stage == 2 || this.state.width > 767) && (
            ...
            <div className="col-12 col-md-7 col-lg-9 no-scrollbar " style={{ height: this.state.width > 767 ? 'calc(100vh - 50px)' : '', overflow: this.state.width > 767 ? 'auto' : '' }}>
              ...
              {this.state.info && (
                <div className={"row " + (this.state.width > 767 ? 'h-100' : '')}>
                  <div className=" col-md-12 col-lg-8 p-0  detail order-lg-1 order-2 pb-5">
                      ...
                      <div className="container">
                        <div className=" py-3">
                          ...
                          <div className="d-flex mt-3">
                            <div className="mt-2">
                              <img src={imageAddress(this.state.info?.creator?.image, 'tickeProfile', 'small')} className=" profile-img1" />
                            </div>
                            <div>
                              <p className="text-smallest text-uppercase px-2 text-bold" style={{ color: '#789' }}>{this.state.info?.creator?.fullname} - {moment(this.state.info?.cDate).format('MMM YYYY, DD HH:mm')}</p>
                              <div className="ticketBox  ">
                                <div className='ck-content'>
                                  <p className="chatbox-desc" dangerouslySetInnerHTML={{ __html: this.state.info?.body }}></p>
                                </div>
                                <div className="flexc flex-wrap ">
                    ...
                    <div className={""} style={{ position: 'sticky', top: 0, }}>
                      ...
                      <div className=" py-3 w-100 container">
                        <div className="profile1 flexc">
                          ...
                          <img src={imageAddress(this.state.info?.creator?.image, 'tickeProfile', 'small')} className="profile1-img" />
                          <div className="mx-2">
                            <p className="profile1-desc1">{this.state.info?.creator?.fullname}</p>
                            <p className="profile1-desc2">User</p>
                          </div>
                        </div>
                        {/* <div>
                      ...
                      <div className="container">
                        <Collapsible open={this.state.showList || this.state.width > 991}>
                          ...
                          <div className="ticketing-information px-2">

                            <div className=" ticketing-priority mt-3">
                              <p className=" ticketing-side-info">Status</p>
                            ...
                            <div className="ticketing-duedate">
                              <p className="ticketing-side-info">Create Date</p>
                              <p className="ticketing-duedate-date1 mld-4 text-end">{moment(this.state.info?.cDate).format("MMM YYYY, DD (HH:mm)")}</p>
                            </div>

                            <div className="ticketing-duedate">
                              <p className="ticketing-side-info">Last Update</p>
                              <p className="ticketing-duedate-date1 mld-4 text-end">{moment(this.state.info?.uDate).format("MMM YYYY, DD (HH:mm)")}</p>
                            </div>

                            <div className=" ticketing-reporter">
                              <p className=" ticketing-side-info">User</p>
                        ...
                        {this.state.width < 992 && (
                          <p onClick={() => this.setState({ showList: !this.state.showList })} className="collaps-p py-2 px-0 m-0" style={{ color: '#007aff', cursor: 'pointer' }}>{this.state.showList ? "Hide" : "Show"} information</p>
                        )}
                      </div>
        ...
        <Modal1 ref={el => this.addModal = el} maxWidth={800}>
          <div style={{}}>
            <div className="container">
              <div className="box px-3 mt-5 pb-3" style={{ maxWidth: "500px" }}>
